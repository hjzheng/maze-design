...
export default function CubeMaze() {
    ...
    const uv = [
        // 前面
        1/4, 1/3, 1/2, 1/3, 1/4, 2/3, 1/2, 2/3,
        // 后面
        1, 1/3, 3/4, 1/3, 1, 2/3, 3/4, 2/3,
        // 上面
        1/4, 2/3, 1/2, 2/3, 1/4, 1, 1/2, 1,
        // 下面
        1/4, 0, 1/2, 0, 1/4, 1/3, 1/2, 1/3,
        // 左面
        0, 1/3, 0.25, 1/3, 0, 2/3, 1/4, 2/3,
        // 右面
        3/4, 1/3, 1/2, 1/3, 3/4, 2/3, 1/2, 2/3,
      ];
